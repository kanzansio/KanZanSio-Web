...
const initiateINC = () => {
    ...
    value >= 83.3333 ? value = 0 : value += 16.666666666667
...
const initiateDEC = () => {
    ...
    value <= 0 ? value = 83.3333 : value -= 16.666666666667
     // update trailValue based on value
    trailUpdate()
}
...
tl.from(".bg", {x: "-100%", opacity: 0})
  .from("p", {opacity: 0, y: "-30px"}, "-=0.1")
  .from("h1", {opacity: 0, y: "30px"}, "-=0.3")
  .from("h2", {opacity: 0, y: "-30px"}, "-=0.5")
  .from(".ver-mas", {opacity: 0, y: "-40px"}, "-=0.8")
